...
const SCREENS: &[Screen] = &[
    ...
    ("identities", chainvue_ui::fixtures::claiming_authority),
    ("identities", chainvue_ui::fixtures::claiming_review),
    ("identities", chainvue_ui::fixtures::identity_detail),
    ("identities", chainvue_ui::fixtures::identity_authorities),
    ("currencies", chainvue_ui::fixtures::currencies),
    ("currencies", chainvue_ui::fixtures::currency_kind),
    ("currencies", chainvue_ui::fixtures::currency_identity),
    ("currencies", chainvue_ui::fixtures::defining_currency),
    ("currencies", chainvue_ui::fixtures::currency_nft),
    ("currencies", chainvue_ui::fixtures::currency_reserve_picker),
    ("currencies", chainvue_ui::fixtures::currency_review),
    ("currencies", chainvue_ui::fixtures::currency_authority),
    ("currencies", chainvue_ui::fixtures::launching_currency),
    (
        "currencies",
        chainvue_ui::fixtures::claiming_a_name_for_a_currency,
    ),
    ("currencies", chainvue_ui::fixtures::launch_pending),
    ("currencies", chainvue_ui::fixtures::currencies_empty),
